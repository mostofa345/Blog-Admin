...
      // Throw the backend error message if available (like "Category with this slug already exists.")
      throw new Error(errorData.message || `HTTP error! Status: ${response.status}`);
    }

    return await response.json(); // returns { success: true, message: 'Category created successfully.', data: category }
  } catch (error) {
    // Error stack frame er jaygata ekhane
...
  // useRouter-er poriborton kora hoyeche
...
      
      if (res.success) {
        setMessage("✅ Category added successfully! Redirecting...");
        setCategoryName("");
        setCategorySlug("");
        // Redirecting to category list - useRouter এর পরিবর্তে window.location ব্যবহার করা হলো
...
      }
    } catch (error) {
      // Catching the error thrown from createCategory (e.g., "Category with this slug already exists.")
...
          Add New Category
        </h1>
        {/* Link এর পরিবর্তে <a> ট্যাগ ব্যবহার করা হলো */}
        <a
